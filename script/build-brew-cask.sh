...
homepage='https://github.com/nikitabobko/AeroSpace' # default matches upstream for backward compat
while test $# -gt 0; do
    case $1 in
...
case "$cask_name" in
    ...
    aerospace-adrianlsy) conflicts_with_casks="conflicts_with cask: 'aerospace'";;
    *) echo "Unknown cask name: $cask_name. Allowed cask names: aerospace, aerospace-dev, aerospace-adrianlsy" > /dev/stderr; exit 1;;
esac
