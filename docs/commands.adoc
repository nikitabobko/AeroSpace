...
== exec-and-wait
----
include::aerospace-exec-and-wait.adoc[tags=synopsis]
----
include::aerospace-exec-and-wait.adoc[tags=purpose]
include::aerospace-exec-and-wait.adoc[tags=body]
...
== move-through
----
include::aerospace-move-through.adoc[tags=synopsis]
----
include::aerospace-move-through.adoc[tags=purpose]
include::aerospace-move-through.adoc[tags=body]
...
----
include::aerospace-version.adoc[tags=purpose]
include::aerospace-version.adoc[tags=body]
