...
== disable-auto-raise
----
include::aerospace-disable-auto-raise.adoc[tags=synopsis]
----
include::aerospace-disable-auto-raise.adoc[tags=purpose]
include::aerospace-disable-auto-raise.adoc[tags=body]
...
== enable-auto-raise
----
include::aerospace-enable-auto-raise.adoc[tags=synopsis]
----
include::aerospace-enable-auto-raise.adoc[tags=purpose]
include::aerospace-enable-auto-raise.adoc[tags=body]
