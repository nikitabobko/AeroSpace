...
[verse]
// tag::synopsis[]
aeroshift focus [-h|--help] [--ignore-floating] [--wrap-around]
                [--boundaries <boundary>] [--boundaries-action <action>]
                (left|down|up|right)
aeroshift focus [-h|--help] [--ignore-floating] [--wrap-around]
                [--boundaries <boundary>] [--boundaries-action <action>]
                (dfs-next|dfs-prev)
aeroshift focus [-h|--help] --window-id <window-id>
aeroshift focus [-h|--help] --dfs-index <dfs-index>
