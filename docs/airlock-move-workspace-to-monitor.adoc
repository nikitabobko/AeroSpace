= airlock-move-workspace-to-monitor(1)
include::util/man-attributes.adoc[]
:manname: airlock-move-workspace-to-monitor
// tag::purpose[]
...
[verse]
// tag::synopsis[]
airlock move-workspace-to-monitor [-h|--help] [--workspace <workspace>] [--wrap-around] (left|down|up|right)
airlock move-workspace-to-monitor [-h|--help] [--workspace <workspace>] [--wrap-around] (next|prev)
airlock move-workspace-to-monitor [-h|--help] [--workspace <workspace>] <monitor-pattern>...
