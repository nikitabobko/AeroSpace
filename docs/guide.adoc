...
NOTE: AeroShift is an unofficial fork of upstream AeroSpace. When upstream issues or links appear below, they are cited as upstream history or reference material.
...
Download release artifacts from this fork, not from upstream AeroSpace.

. Download the latest available zip from https://github.com/Boredphilosopher96/AeroSpace/releases[the fork releases page]
. Unpack zip
...
Contributor and release-install notes are covered in https://github.com/Boredphilosopher96/AeroSpace/blob/main/dev-docs/development.md[Development Notes].
