...
== Synopsis
// tag::synopsis[]
aerospace move [-h|--help] (left|down|up|right) [floating-pixels]
// end::synopsis[]
...
The optional `floating-pixels` argument specifies how far the window should be moved if it is floating.
