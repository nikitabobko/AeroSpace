...
There is a third party Alfred workflow for AeroSpace. https://github.com/hmepas/alfred_fzf_aerospace_workflow

Help searching windows and changing focus to them right from Alfred via aw command.
