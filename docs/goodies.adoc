...
NOTE: AeroShift is an unofficial fork of upstream AeroSpace. Some third-party integrations below were originally written for AeroSpace and may need small command-name adjustments for `aeroshift`.
...
There is a third-party Raycast extension for upstream AeroSpace: https://www.raycast.com/limonkufu/aerospace
