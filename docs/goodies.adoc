...
* https://github.com/pszypowicz/cyclist[Cyclist] - speed-first switching: Alt+Tab, the native Spaces swipe, and Ctrl+Arrows without animations, AeroSpace workspaces understood natively.
