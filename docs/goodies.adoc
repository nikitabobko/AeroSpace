...
The third-party https://www.raycast.com/limonkufu/aerospace[AeroSpace Raycast extension] targets the `aerospace` executable.
...
You can integrate FlightDeck workspace indicators with link:https://github.com/FelixKratz/SketchyBar[Sketchybar].
...
link:https://github.com/Jean-Tinland/simple-bar[simple-bar] can be used to display FlightDeck workspaces.
