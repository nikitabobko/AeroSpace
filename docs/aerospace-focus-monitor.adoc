= aeroshift-focus-monitor(1)
include::util/man-attributes.adoc[]
:manname: aeroshift-focus-monitor
// tag::purpose[]
...
[verse]
// tag::synopsis[]
aeroshift focus-monitor [-h|--help] [--wrap-around] (left|down|up|right)
aeroshift focus-monitor [-h|--help] [--wrap-around] (next|prev)
aeroshift focus-monitor [-h|--help] <monitor-pattern>...
