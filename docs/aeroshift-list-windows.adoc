= aeroshift-list-windows(1)
include::util/man-attributes.adoc[]
:manname: aeroshift-list-windows
// tag::purpose[]
...
[verse]
// tag::synopsis[]
aeroshift list-windows [-h|--help] (--workspace <workspace>...|--monitor <monitor>...)
                       [--monitor <monitor>...] [--workspace <workspace>...]
                       [--pid <pid>] [--app-bundle-id <app-bundle-id>] [--format <output-format>]
                       [--count] [--json]
aeroshift list-windows [-h|--help] --all [--format <output-format>] [--count] [--json]
aeroshift list-windows [-h|--help] --focused [--format <output-format>] [--count] [--json]
