= airlock-list-windows(1)
include::util/man-attributes.adoc[]
:manname: airlock-list-windows
// tag::purpose[]
...
[verse]
// tag::synopsis[]
airlock list-windows [-h|--help] (--workspace <workspace>...|--monitor <monitor>...)
                       [--monitor <monitor>...] [--workspace <workspace>...]
                       [--pid <pid>] [--app-bundle-id <app-bundle-id>] [--format <output-format>]
                       [--count] [--json]
airlock list-windows [-h|--help] --all [--format <output-format>] [--count] [--json]
airlock list-windows [-h|--help] --focused [--format <output-format>] [--count] [--json]
...
%{window-is-fullscreen}:: Boolean. Is window in fullscreen by `airlock fullscreen` command
