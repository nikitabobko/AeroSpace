= airlock-move-mouse(1)
include::./util/man-attributes.adoc[]
// tag::purpose[]
:manpurpose: Move mouse to the requested position
// end::purpose[]
:manname: airlock-move-mouse

// =========================================================== Synopsis
== Synopsis
[verse]
// tag::synopsis[]
airlock move-mouse [-h|--help] [--fail-if-noop] <mouse-position>
...
`airlock move-mouse window-lazy-center || airlock move-mouse monitor-lazy-center`
