= airlock-focus-monitor(1)
include::util/man-attributes.adoc[]
:manname: airlock-focus-monitor
// tag::purpose[]
...
[verse]
// tag::synopsis[]
airlock focus-monitor [-h|--help] [--wrap-around] (left|down|up|right)
airlock focus-monitor [-h|--help] [--wrap-around] (next|prev)
airlock focus-monitor [-h|--help] <monitor-pattern>...
