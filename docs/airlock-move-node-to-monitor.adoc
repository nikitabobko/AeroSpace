= airlock-move-node-to-monitor(1)
include::util/man-attributes.adoc[]
:manname: airlock-move-node-to-monitor
// tag::purpose[]
...
[verse]
// tag::synopsis[]
airlock move-node-to-monitor [-h|--help] [--window-id <window-id>] [--focus-follows-window]
...
This flag is a shortcut for manually running `airlock-workspace`/`airlock-focus` after `move-node-to-monitor` successful execution.
