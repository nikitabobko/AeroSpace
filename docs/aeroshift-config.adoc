...
:manname: aeroshift-config
// tag::purpose[]
:manpurpose: Query Aeroshift config options
// end::purpose[]
...
[verse]
// tag::synopsis[]
aeroshift config [-h|--help] --get <name> [--json] [--keys]
aeroshift config [-h|--help] --major-keys
aeroshift config [-h|--help] --all-keys
aeroshift config [-h|--help] --config-path
...
+
----
$ aeroshift config --get mode --keys
main
service
----
...
+
----
$ aeroshift config --get mode.main.binding --json
{
  "alt-w" : "workspace W",
  "alt-y" : "workspace Y",
  "alt-n" : "workspace N",
