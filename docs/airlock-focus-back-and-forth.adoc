= airlock-focus-back-and-forth(1)
include::util/man-attributes.adoc[]
// tag::purpose[]
:manpurpose: Switch between the current and previously focused elements back and forth
// end::purpose[]
:manname: airlock-focus-back-and-forth

// =========================================================== Synopsis
== Synopsis
[verse]
// tag::synopsis[]
airlock focus-back-and-forth [-h|--help]
...
Airlock stores only one previously focused window in history,
...
----
airlock focus-back-and-forth || airlock workspace-back-and-forth
----
