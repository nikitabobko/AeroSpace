...
[verse]
// tag::synopsis[]
airlock workspace [-h|--help] [--auto-back-and-forth] [--fail-if-noop] <workspace-name>
airlock workspace [-h|--help] [--wrap-around] [--stdin|--no-stdin] (next|prev)
...
`airlock list-workspaces --monitor focused --empty no | airlock workspace --stdin next`
