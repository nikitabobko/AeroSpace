...
[verse]
// tag::synopsis[]
aeroshift workspace [-h|--help] [--auto-back-and-forth] [--fail-if-noop] <workspace-name>
aeroshift workspace [-h|--help] [--wrap-around] [--stdin|--no-stdin] (next|prev)
...
`aeroshift list-workspaces --monitor focused --empty no | aeroshift workspace --stdin next`
