= airlock-fullscreen(1)
include::util/man-attributes.adoc[]
:manname: airlock-fullscreen
// tag::purpose[]
...
[verse]
// tag::synopsis[]
airlock fullscreen [-h|--help]     [--window-id <window-id>] [--no-outer-gaps]
airlock fullscreen [-h|--help] on  [--window-id <window-id>] [--no-outer-gaps] [--fail-if-noop]
airlock fullscreen [-h|--help] off [--window-id <window-id>] [--fail-if-noop]
