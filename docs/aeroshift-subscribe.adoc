= aeroshift-subscribe(1)
include::util/man-attributes.adoc[]
// tag::purpose[]
:manpurpose: Subscribe to Aeroshift events and receive notifications via socket
// end::purpose[]
:manname: aeroshift-subscribe

// =========================================================== Synopsis
== Synopsis
[verse]
// tag::synopsis[]
aeroshift subscribe [-h|--help] [--all] [--no-send-initial] [<event>...]
...
This command connects to the Aeroshift server and receives real-time event notifications as JSON lines.
