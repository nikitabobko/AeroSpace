= airlock-macos-native-fullscreen(1)
include::util/man-attributes.adoc[]
:manname: airlock-macos-native-fullscreen
// tag::purpose[]
...
[verse]
// tag::synopsis[]
airlock macos-native-fullscreen [-h|--help] [--window-id <window-id>]
airlock macos-native-fullscreen [-h|--help] [--window-id <window-id>] [--fail-if-noop] on
airlock macos-native-fullscreen [-h|--help] [--window-id <window-id>] [--fail-if-noop] off
