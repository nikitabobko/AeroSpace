...
:manname: airlock-config
// tag::purpose[]
:manpurpose: Query Airlock config options
// end::purpose[]
...
[verse]
// tag::synopsis[]
airlock config [-h|--help] --get <name> [--json] [--keys]
airlock config [-h|--help] --major-keys
airlock config [-h|--help] --all-keys
airlock config [-h|--help] --config-path
...
+
----
$ airlock config --get mode.main.binding --json
{
  "alt-w" : "workspace W",
  "alt-y" : "workspace Y",
  "alt-n" : "workspace N",
