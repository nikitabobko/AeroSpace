= aeroshift-focus-back-and-forth(1)
include::util/man-attributes.adoc[]
// tag::purpose[]
:manpurpose: Switch between the current and previously focused elements back and forth
// end::purpose[]
:manname: aeroshift-focus-back-and-forth

// =========================================================== Synopsis
== Synopsis
[verse]
// tag::synopsis[]
aeroshift focus-back-and-forth [-h|--help]
...
Aeroshift stores only one previously focused window in history,
...
----
aeroshift focus-back-and-forth || aeroshift workspace-back-and-forth
----
