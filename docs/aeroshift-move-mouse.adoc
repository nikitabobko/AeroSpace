= aeroshift-move-mouse(1)
include::./util/man-attributes.adoc[]
// tag::purpose[]
:manpurpose: Move mouse to the requested position
// end::purpose[]
:manname: aeroshift-move-mouse

// =========================================================== Synopsis
== Synopsis
[verse]
// tag::synopsis[]
aeroshift move-mouse [-h|--help] [--fail-if-noop] <mouse-position>
...
`aeroshift move-mouse window-lazy-center || aeroshift move-mouse monitor-lazy-center`
