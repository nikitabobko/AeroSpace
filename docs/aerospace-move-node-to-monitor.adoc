...
[verse]
// tag::synopsis[]
aerospace move-node-to-monitor [-h|--help] [--window-id <window-id>] [--focus-follows-window] [--wrap-around] (left|down|up|right)
aerospace move-node-to-monitor [-h|--help] [--window-id <window-id>] [--focus-follows-window] [--wrap-around] (next|prev)
aerospace move-node-to-monitor [-h|--help] [--window-id <window-id>] [--focus-follows-window] <monitor-pattern>...
