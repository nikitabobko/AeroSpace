...
[verse]
// tag::synopsis[]
airlock focus [-h|--help] [--ignore-floating] [--wrap-around]
                [--boundaries <boundary>] [--boundaries-action <action>]
                (left|down|up|right)
airlock focus [-h|--help] [--ignore-floating] [--wrap-around]
                [--boundaries <boundary>] [--boundaries-action <action>]
                (dfs-next|dfs-prev)
airlock focus [-h|--help] --window-id <window-id>
airlock focus [-h|--help] --dfs-index <dfs-index>
...
https://github.com/nikitabobko/Airlock/issues/5
