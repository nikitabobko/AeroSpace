...
[verse]
// tag::synopsis[]
aerospace fullscreen [-h|--help]     [--window-id <window-id>] [--no-outer-gaps] [--hide-others]
aerospace fullscreen [-h|--help] on  [--window-id <window-id>] [--no-outer-gaps] [--hide-others] [--fail-if-noop]
...
--hide-others:: The flag is useful when the window you're about to fullscreen is transparent. All other non-fullscreen windows of the workspace will be hidden in the corner.
