...
// end::purpose[]
:manname: aeroshift-volume

// =========================================================== Synopsis
== Synopsis
[verse]
// tag::synopsis[]
aeroshift volume [-h|--help] (up|down) [--no-gui]
aeroshift volume [-h|--help] (mute-toggle|mute-off|mute-on) [--no-gui]
aeroshift volume [-h|--help] set <number> [--no-gui]
