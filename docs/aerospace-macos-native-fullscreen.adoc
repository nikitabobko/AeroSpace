= aeroshift-macos-native-fullscreen(1)
include::util/man-attributes.adoc[]
:manname: aeroshift-macos-native-fullscreen
// tag::purpose[]
...
[verse]
// tag::synopsis[]
aeroshift macos-native-fullscreen [-h|--help] [--window-id <window-id>]
aeroshift macos-native-fullscreen [-h|--help] [--window-id <window-id>] [--fail-if-noop] on
aeroshift macos-native-fullscreen [-h|--help] [--window-id <window-id>] [--fail-if-noop] off
