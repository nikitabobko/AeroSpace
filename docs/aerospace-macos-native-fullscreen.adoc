...
[verse]
// tag::synopsis[]
aerospace macos-native-fullscreen [-h|--help]
aerospace macos-native-fullscreen [-h|--help] [--fail-if-noop] on
aerospace macos-native-fullscreen [-h|--help] [--fail-if-noop] off
