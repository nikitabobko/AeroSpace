= aeroshift-move-workspace-to-monitor(1)
include::util/man-attributes.adoc[]
:manname: aeroshift-move-workspace-to-monitor
// tag::purpose[]
...
[verse]
// tag::synopsis[]
aeroshift move-workspace-to-monitor [-h|--help] [--workspace <workspace>] [--wrap-around] (left|down|up|right)
aeroshift move-workspace-to-monitor [-h|--help] [--workspace <workspace>] [--wrap-around] (next|prev)
aeroshift move-workspace-to-monitor [-h|--help] [--workspace <workspace>] <monitor-pattern>...
