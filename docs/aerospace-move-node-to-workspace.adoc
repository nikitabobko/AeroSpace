...
[verse]
// tag::synopsis[]
aerospace move-node-to-workspace [-h|--help] [--focus-follows-window] [--wrap-around] (next|prev)
aerospace move-node-to-workspace [-h|--help] [--focus-follows-window] [--fail-if-noop] [--window-id <window-id>] <workspace-name>
