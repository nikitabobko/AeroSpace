...
let subcommandDescriptions = [
    ...
    ["  list-monitors", "Prints monitors that satisfy pattern"],
    ["  list-windows", "Prints windows that satisfy pattern"],
    ["  list-workspaces", "Prints workspaces that satisfy pattern"],
