            ...
            case .failure(let err):
                assertEquals(err, """
                    ERROR: Can't parse 'unknown-event'.
                           Possible values: (focus-changed|focused-monitor-changed|focused-workspace-changed|mode-changed|window-detected|window-destroyed|window-moved|binding-triggered)
                    """)
        }
    }
