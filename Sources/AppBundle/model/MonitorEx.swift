...
extension MonitorInfo {
    ...
    // Windows cannot be clipped and may enforce a minimum width, so even a distant monitor
    // to the right makes peeking unsafe. Use physical bounds to include menu-bar areas.
