...
class Window: TreeNode, Hashable {
    ...
    @MainActor
    func close() { error("Not implemented") }
    ...
    func getTopLeftCorner() async throws -> CGPoint? { error("Not implemented") }
    @MainActor // todo swift is stupid
    func getSize() async throws -> CGSize? { error("Not implemented") }
    @MainActor // todo swift is stupid
    ...
    @MainActor // todo can be dropped in future Swift versions
    func getRect() async throws -> Rect? { error("Not implemented") }
    @MainActor // todo can be dropped in future Swift versions
    func getCenter() async throws -> CGPoint? { try await getRect()?.center }
