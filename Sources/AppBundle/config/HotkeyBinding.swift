...
func parseBindings(_ raw: OrderedJson, _ backtrace: ConfigBacktrace, _ c: inout ConfigParserContext, _ mapping: KeyMapping) -> [HotkeyBinding] {
...
func parseBinding(_ raw: String, _ backtrace: ConfigBacktrace, _ mapping: KeyMapping) -> ResOrConfigParseDiagnostic<Hotkey> {
    ...
    return modifiers.flatMap { modifiers -> ResOrConfigParseDiagnostic<Hotkey> in
        key
            ...
            .flatMap { key -> ResOrConfigParseDiagnostic<Hotkey> in
