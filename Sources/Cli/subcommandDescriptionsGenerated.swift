...
let subcommandDescriptions = [
    ...
    ["  config", "Query Aeroshift config options"],
    ...
    ["  subscribe", "Subscribe to Aeroshift events and receive notifications via socket"],
    ...
    ["  trigger-binding", "Trigger an Aeroshift binding as if it was pressed by user"],
