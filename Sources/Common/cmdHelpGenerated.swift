...
let fullscreen_help_generated = """
    USAGE: fullscreen [-h|--help]     [--window-id <window-id>] [--no-outer-gaps] [--hide-others]
       OR: fullscreen [-h|--help] on  [--window-id <window-id>] [--no-outer-gaps] [--hide-others] [--fail-if-noop]
